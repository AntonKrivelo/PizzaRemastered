...
const CartItem = ({id, name, price, type, count, image, size}) => {
    ...
    return (
        <div class="cart__item">
            ...
            <div class="cart__item-count">
                <div onClick={onClickRemove} class="button button--outline button--circle cart__item-count-minus">
            ...
            <div class="cart__item-price">
                ...
                <div onClick={removeClick} class="cart__item-remove">
